    ...
    <main className="min-h-screen bg-white">
      ...
      <nav className="flex justify-between items-center px-6 py-4 max-w-6xl mx-auto">
        ...
        <div className="flex gap-3">
          <a href="/login" className="text-sm text-gray-600 hover:text-gray-900 px-4 py-2">
            Connexion
          </a>
          <a href="/register" className="text-sm bg-violet-600 text-white px-4 py-2 rounded-full hover:bg-violet-700">
      ...
      <section className="bg-violet-600 mx-4 rounded-2xl px-6 py-16 text-center mt-2 max-w-6xl lg:mx-auto">
        ...
        <h1 className="text-3xl md:text-5xl font-medium text-white leading-tight mb-4">
          Trouve ton <span className="text-yellow-300">code parrainage</span>
          <br />
        ...
        <div className="flex gap-3 justify-center flex-wrap mb-10">
          <a href="/codes" className="bg-yellow-300 text-yellow-900 font-medium px-6 py-3 rounded-xl text-sm hover:bg-yellow-400">
            Trouver un code gratuit
          </a>
          <a href="/register" className="border border-white/40 text-white px-6 py-3 rounded-xl text-sm hover:bg-white/10">
            Publier mon code →
          </a>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
          {[
            ...
            <a
              ...
              className="bg-white border border-gray-100 rounded-xl p-4 hover:border-violet-300 transition-colors"
            >
      ...
      <section className="max-w-6xl mx-auto px-4 pb-12">
        ...
        <div className="flex flex-wrap gap-2">
          {[
            ...
            "Code parrainage Winamax",
            "Code parrainage Fortuneo",
            "Code parrainage Free",
            "Code parrainage Binance",
            "Code parrainage BetClic",
            "Code parrainage Hello bank",
            "Code parrainage Coinbase",
            "Code parrainage Lydia",
            "Code parrainage Revolut",
          ].map((tag) => (
            <a
              key={tag}
              href={"/code-parrainage/" + tag.split(" ").pop()?.toLowerCase()}
              className="text-xs bg-gray-100 text-gray-600 rounded-lg px-3 py-2 hover:bg-violet-100 hover:text-violet-700 transition-colors"
            >
              {tag}
            </a>
          ))}
