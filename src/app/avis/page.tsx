          ...
          {step === "positive" && (
            <div style={{ textAlign:"center", animation:"fadeIn .3s ease" }}>
              ...
              <a
                ...
                style={{ display:"inline-flex", alignItems:"center", gap:8, background:"#4285F4", color:"#fff", textDecoration:"none", borderRadius:13, padding:".875rem 1.75rem", fontWeight:700, fontSize:".9rem", fontFamily:"'DM Sans',sans-serif", transition:"all .2s" }}
