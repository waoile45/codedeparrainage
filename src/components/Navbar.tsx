...
export default function Navbar({ activePage, isLoggedIn = false, pseudo = "Moi" }: NavbarProps) {
    ...
    <>
      ...
      <div style={{ position: "sticky", top: 0, zIndex: 200 }}>
                  ...
                  {menuOpen && (
                    <div className="nav-dropdown">
                      ...
                      <div className="nav-dropdown-section">
                        ...
                        <button className="nav-dropdown-item danger" onClick={()=>{ setMenuOpen(false); /* supabase.auth.signOut() */ }}>
        ...
        <div className={`nav-mobile ${menuOpen ? "open" : ""}`}>
          ...
          {isLoggedIn
            ? <button className="nav-mobile-link" style={{ color:"#f87171" }} onClick={()=>{ setMenuOpen(false); }}>🚪 Déconnexion</button>
            : <>
